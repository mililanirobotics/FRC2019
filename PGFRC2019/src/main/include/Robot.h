...
class Robot : public frc::SampleRobot {
 ...
 private:
  ...
  frc::DigitalInput limitSwitchOne;
  frc::DigitalInput limitSwitchTwo;
  frc::DoubleSolenoid solenoidOne;
  frc::DoubleSolenoid solenoidTwo;
  frc::DoubleSolenoid solenoidThree;
  frc::DoubleSolenoid solenoidFour;
